...
if user==0:
    ...
    libra_x_path = "/budgetdata/academic/alexeyak/ekadashi/libX_application/Azo/Cis_to_Trans/S1-S0/src"
...
params["Nsnaps"]=2000      # the number of MD rounds
params["Nsteps"]=2      # the number of MD steps per snap
params["Ncool"] = -1
params["nspin"] = 2
params["electronic_smearing"] = 0.005 # Electronic smearing used in Fermi population calculation
params["nconfig"] = 1
params["el_mts"] = 1
params["num_SH_traj"] = 1
params["max_iteration"] = 30
params["scf_itr"] = 10
...
params["sigma_pos"] = 0.05  #Displace atomic position randomly
params["Nstart"] = 0
